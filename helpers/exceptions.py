...
class CustomerT24Existance(BaseException):
    status_code = 400
    default_code = 135
    default_detail = "Sorry, You are already an existing customer in GTI, pelase singup up as existing customer"
...
class UpdateNotAllowedException(BaseException):
    status_code = 400
    default_code = 137
    default_detail = "This record cannot be updated. You can only update this information once every 90 days."
